...
import { X, Check, Sparkles, MapPin, Film, Heart } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-start justify-between border-b border-stone-800 pb-5 mb-6">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-amber-400 via-emerald-400 to-teal-300 bg-clip-text text-transparent">
              Quel Dialecte Parlé Voulez-Vous Maîtriser ?
            </h2>
            <p className="text-sm text-stone-300 mt-1">
              Contrairement à l'arabe scolaire littéraire, chaque région arabe a son propre "parler de la rue". Choisissez celui qui correspond à vos voyages ou à votre entourage !
            </p>
          </div>
          <button
            onClick={onClose}
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <div className="bg-stone-900/80 rounded-xl p-3 mb-4 border border-stone-700/60 space-y-2">
                    ...
                    <div className="flex items-baseline justify-between">
                      ...
                      <span className="text-amber-300 font-arabic text-base font-bold">
                ...
                <div className="mt-5 pt-4 border-t border-stone-700/60 flex items-center justify-between">
                  ...
                  >
                    {isSelected ? 'Dialecte sélectionné' : 'Choisir ce dialecte'}
                  </button>
                </div>
              </div>
            );
        ...
        <div className="mt-8 p-4 bg-stone-950/60 rounded-2xl border border-stone-800 text-center">
          <p className="text-xs text-stone-400">
            💡 <strong className="text-stone-200">Conseil d'immersion :</strong> Vous pouvez changer de dialecte à tout moment depuis le menu en haut. Les 500 mots de survie s'adapteront automatiquement !
          </p>
        </div>
      </div>
    </div>
