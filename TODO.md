...
- [x] Code couleur par langue : champ accent hex dans LANGUAGES, appliqué à TOUT le site (couleur accent Tailwind branchée sur la variable CSS, plus aucun ambre en dur)
